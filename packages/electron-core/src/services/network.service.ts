...
/**
 * Probes API reachability + latency to classify connection quality. Renderer-
 * agnostic: the host passes the API base URL (electron-core does not own app config).
 */
