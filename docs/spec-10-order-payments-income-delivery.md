...
- [x] Slice ③ — Delivery zones (multi‑country). **Done:** geography reference data (CM/NG/AE) + public
  ...
  storefront checkout (country/region/city selects + live zone fee + block/arrange); desktop store‑config
