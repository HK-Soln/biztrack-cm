...
// Applies the persisted palette/chrome attributes before first paint to avoid
// a theme flash. next-themes injects its own no-flash script for the .dark class.
