...
import { CustomerDeposit } from './customer-deposit.entity'
...
export class DepositTransaction extends TypeOrmBaseEntity {
  @PrimaryColumn('uuid')
  id!: string
...
export { DepositTransaction as SavingsTransaction }
