...
// Main-process configuration — the single place the main process reads env. VITE_API_URL and
// VITE_STOREFRONT_DOMAIN are baked at BUILD time by electron-vite (see the `define` in
