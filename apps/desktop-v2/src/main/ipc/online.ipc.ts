...
import type { CreateOnlineStoreRequest, UpdateOnlineStoreRequest, UpdateOrderStatusRequest } from '@biztrack/types'
...
export function registerOnlineIpc(online: OnlineService): void {
  ...
  ipcMain.handle(IPC.onlineStoreCreate, (_e, input: CreateOnlineStoreRequest) => online.createStore(input))
  ipcMain.handle(IPC.onlineStoreUpdate, (_e, input: UpdateOnlineStoreRequest) => online.updateStore(input))
